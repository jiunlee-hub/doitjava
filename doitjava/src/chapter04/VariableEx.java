...
public class VariableEx {
	...
	public static void main(String[] args) {
		...
		int order1=0, order2=0, order3=0, order4=0; // 변수 선언 후 초기값을 넣어주는 것이 좋다.
		// 변수의 초기값은 숫자는 0, boolean false, 문자열 "", char형은 0으로 초기화
		order1 = 2;
		order2 = 1;
		order3 = 6;
		order4 = 1;
		...
		System.out.println("총금액은"+(res1+res2+res3+res4)+"원입니다.");
		System.out.print("출력");
		System.out.print("출력\n");
		System.out.print("출력");
	}
